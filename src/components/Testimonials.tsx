...
const testimonials = [
    {
        id: 1,
        quote: "Sabarish delivered our school website with incredible attention to detail. The design was modern, responsive, and exactly what we envisioned.",
        author: "SSV School",
        role: "Client Project"
    },
    {
        id: 2,
        quote: "Impressive work for a student developer. The code quality and design sensibility are well beyond his experience level.",
        author: "Freelance Client",
        role: "Web Development"
    },
    {
        id: 3,
        quote: "He understood our requirements perfectly and delivered a clean, functional website ahead of the deadline. Highly recommended.",
        author: "Freelance Client",
    ...
    return (
        <section ref={sectionRef} className="py-24 px-6 md:px-12 lg:px-24 bg-[#050505] text-white w-full relative z-30">
            <div className="flex flex-col items-center text-center mb-16 md:mb-24 test-header">
                <p className="text-gray-400 uppercase tracking-widest text-sm mb-4 font-semibold">Feedback</p>
                <h2 className="text-5xl md:text-7xl font-bold font-serif italic max-w-3xl">What Clients Say</h2>
            </div>
