...
const qualifications = [
    {
        id: 1,
        title: "B.Tech in CSE (Gen AI)",
        institution: "Jain Global Campus",
        year: "2025 - 2029",
        description: "Currently pursuing a Bachelor of Technology in Computer Science and Engineering with a specialisation in Generative AI.",
    ...
    },
    {
        ...
        year: "2023",
        description: "Completed a comprehensive course covering WebGL, Three.js, and advanced GSAP techniques for building modern, animated web experiences.",
        icon: <Hexagon className="w-6 h-6" />
    },
    {
        id: 3,
        title: "Certified Java OOPs",
        institution: "Oracle",
        year: "2023",
        description: "Completed the Oracle certification in Java Object-Oriented Programming, covering core concepts such as inheritance, polymorphism, encapsulation, and abstraction.",
