...
const experiences = [
    {
        ...
        period: "2024 - Present",
        description: "Building responsive, high-performance websites for clients as a freelancer. Specialising in modern front-end technologies including React, GSAP animations, and Tailwind CSS.",
    },
    {
        id: 2,
        role: "Student Developer",
        company: "Jain Global Campus",
        period: "2025 - Present",
        description: "Actively building academic and personal projects while pursuing B.Tech in CSE (Gen AI). Exploring full-stack development, AI/ML, and creative web experiences.",
    },
    {
        id: 3,
        ...
        company: "Independent",
        period: "2022 - 2024",
        description: "Started the coding journey by self-learning HTML, CSS, JavaScript, and Python. Built multiple projects to solidify fundamentals before entering university.",
    }
];
        ...
        <section ref={sectionRef} className="py-24 px-6 md:px-12 lg:px-24 bg-black text-white w-full relative z-30 border-t border-gray-900">
            <div className="flex flex-col lg:flex-row gap-16 md:gap-24">
                ...
                <div className="w-full lg:w-1/3 exp-header">
                    <p className="text-gray-400 uppercase tracking-widest text-sm mb-4 font-semibold">Journey</p>
                    <h2 className="text-5xl md:text-7xl font-bold font-serif italic mb-8">My<br />Journey</h2>
                    <p className="text-gray-400 leading-relaxed text-lg max-w-sm">
                        A timeline of my learning journey, from self-taught programmer to freelance web developer.
                    </p>
                </div>
